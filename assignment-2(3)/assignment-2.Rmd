...
In this part, we fit the multiple regression model in INLA using the priors we chosen in the previous part. The mean of the regression coefficients can be found in the first column of the summary results. For the categorical covariates with the number of catogories $k$, INLA will automatically create $k-1$ indicators.
```{r}
#Priors for the regression coefficients.
prior.beta <- list(mean.intercept = 0, prec.intercept =  0.31,
                    mean =0, 
